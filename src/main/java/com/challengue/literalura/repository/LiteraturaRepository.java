package com.challengue.literalura.repository;

import com.challengue.literalura.model.Autor;
import com.challengue.literalura.model.Idioma;
...
public interface LiteraturaRepository extends JpaRepository<Autor, Long> {
